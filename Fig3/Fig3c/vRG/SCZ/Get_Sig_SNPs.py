...
SNPS = '/shen/shenlabstore3/ijones1/GKM_explain_test/SCZ_snps/Scz.Filt.allATAC.SNPs.5.1.24.csv'

# GKM input
GKM_ref = 'Scz.Filt.allATAC.SNPs.200bp.5.1.24.V2.txt'
GKM_alt = 'Scz.Filt.allATAC.ALT.SNPs.200bp.5.1.24.V2.txt'
GKM_ref_shuf = 'Scz_Ref_Shuffled.SNPs.200bp.5.1.24.V2.txt'
GKM_alt_shuf = 'Scz_Alt_Shuffled.SNPs.200bp.5.1.24.V2.txt'

# Read in delta SVM inputs
delta = "Delta_Scz.200bp.Filt.allATAC.txt"
delta_shuf = "Delta_Shuf_Scz.200bp.Filt.allATAC.txt"

# Read in delta SVM inputs
ISM_ref = 'ISM.Scz.Filt.allATAC.SNPs.200bp.5.1.24.V2.txt'
ISM_alt = 'ISM.Scz.Filt.allATAC.ALT.SNPs.200bp.5.1.24.V2.txt'
ISM_ref_shuf = 'ISM.Scz_Ref_Shuffled.SNPs.200bp.5.1.24.V2.txt'
ISM_alt_shuf = 'ISM.Scz_Alt_Shuffled.SNPs.200bp.5.1.24.V2.txt'

# Output csv
output ='vRG.SCZ.8.12.24.csv'
