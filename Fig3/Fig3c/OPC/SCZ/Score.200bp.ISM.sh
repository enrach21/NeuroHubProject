...
INDEX=/shen/shenlabstore3/ijones1/GKM_explain_test/OPC/SCZ_scores_update/fasta.200bp.txt
fasta=$(awk 'FNR == i {print}' i=${SGE_TASK_ID} $INDEX)

INDEX2=/shen/shenlabstore3/ijones1/GKM_explain_test/OPC/SCZ_scores_update/output.200bp.txt
