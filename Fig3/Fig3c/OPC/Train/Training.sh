...
/shen/shenlabstore3/ijones1/dependencies/GKM_Explain/rlsgkm/bin/gkmtrain -r 1 -T 16 -y 0 -t 4 -c 1 -p 0.1 /shen/shenlabstore3/ijones1/GKM_explain_test/OPC/Pos_90k/OPC.train.75k.peaks.filt.fa /shen/shenlabstore3/ijones1/GKM_explain_test/OPC/Neg_90k/OPC.train.75k.neg.filt.fa OPC.Not_chr2.model.8.5.24