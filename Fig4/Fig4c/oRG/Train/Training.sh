...
/shen/shenlabstore3/ijones1/dependencies/GKM_Explain/rlsgkm/bin/gkmtrain -r 1 -T 16 -y 0 -t 4 -c 1 -p 0.1 /shen/shenlabstore3/ijones1/GKM_explain_test/oRG/Pos_90k/oRG.train.75k.peaks.filt.fa /shen/shenlabstore3/ijones1/GKM_explain_test/oRG/Neg_90k/oRG.train.75k.neg.filt.fa oRG.Not_chr2.model.8.5.24