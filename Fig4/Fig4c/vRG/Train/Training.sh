...
/shen/shenlabstore3/ijones1/dependencies/GKM_Explain/rlsgkm/bin/gkmtrain -r 1 -T 16 -y 0 -t 4 -c 1 -p 0.1 /shen/shenlabstore3/ijones1/GKM_explain_test/vRG/Pos_90k/vRG.train.75k.peaks.filt.fa /shen/shenlabstore3/ijones1/GKM_explain_test/vRG/Neg_90k/vRG.train.75k.neg.filt.fa vRG.Not_chr2.model.8.5.24