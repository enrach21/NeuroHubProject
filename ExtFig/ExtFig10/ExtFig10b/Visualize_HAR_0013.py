...
x = 30
plot_weights(impscores_ref[x][85:115],name="human.HARsv2_0013_3.pdf",figsize=(3,.75))


plot_weights(impscores_alt[x][85:115],name="chimp.HARsv2_0013_3.pdf",figsize=(3,.75))

x = 31
plot_weights(impscores_ref[x][85:115],name="human.HARsv2_0013_4.pdf",figsize=(3,.75))


plot_weights(impscores_alt[x][85:115],name="chimp.HARsv2_0013_4.pdf",figsize=(3,.75))