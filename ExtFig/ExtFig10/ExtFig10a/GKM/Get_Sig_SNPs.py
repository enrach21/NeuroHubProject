...
SNPS = '/shen/shenlabstore3/ijones1/dependencies/vcf2maf/HAR/HAR.allATAC.variants.7.22.24.csv'

# GKM input
GKM_ref = 'HAR.allATAC.variants.7.22.24.score.txt'
GKM_alt = 'HAR_ALT.allATAC.variants.7.22.24.V2.score.txt'
GKM_ref_shuf = 'Ref_Shuffled.HAR.allATAC.variants.7.22.24.V2.score.txt'
GKM_alt_shuf = 'Alt_Shuffled.HAR.allATAC.variants.7.22.24.V2.score.txt'

# Read in delta SVM inputs
delta = "Delta_HAR_Score_7_22_24.txt"
delta_shuf = "Shuf_Delta_HAR_Score_7_22_24.txt"

# Read in delta SVM inputs
ISM_ref = 'ISM.HAR.allATAC.variants.7.22.24.score.txt'
ISM_alt = 'ISM.HAR_ALT.allATAC.variants.7.22.24.V2.score.txt'
ISM_ref_shuf = 'ISM.Ref_Shuffled.HAR.allATAC.variants.7.22.24.V2.score.txt'
ISM_alt_shuf = 'ISM.Alt_Shuffled.HAR.allATAC.variants.7.22.24.V2.score.txt'

# Output csv
output ='HAR.8.12.24.csv'

#### Read in SNPs
df = pd.read_csv(SNPS).iloc[:, 1:]
df['loc']= df['X.chrom'] + ':' + df.chromStart.astype(str) + '-' + df.chromEnd.astype(str)
