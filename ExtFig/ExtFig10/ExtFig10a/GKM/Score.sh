...
INDEX=/shen/shenlabstore3/ijones1/GKM_explain_test/oRG/HARs_update/fasta.txt
fasta=$(awk 'FNR == i {print}' i=${SGE_TASK_ID} $INDEX)

INDEX2=/shen/shenlabstore3/ijones1/GKM_explain_test/oRG/HARs_update/output.txt
